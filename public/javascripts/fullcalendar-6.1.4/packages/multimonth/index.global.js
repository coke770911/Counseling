    ...
    render () {
      ...
      return (preact.createElement('div', { ref: props.elRef, 'data-date': props.isoDateStr, className: 'fc-multimonth-month', style: { width: props.width }, role: 'grid', 'aria-labelledby': state.labelId },
        ...
        preact.createElement('tbody', { role: 'rowgroup' },
          preact.createElement(internal$1.TableRows, Object.assign({}, slicedProps, { dateProfile, cells: dayTableModel.cells, eventSelection: props.eventSelection, dayMaxEvents: !forPrint, dayMaxEventRows: !forPrint, showWeekNumbers: options.weekNumbers, clientWidth: props.clientWidth, clientHeight: props.clientHeight, forPrint })))))))
    }
  }
  ...
  class MultiMonthView extends internal.DateComponent {
    ...
    render () {
      ...
      return (preact.createElement(internal.ViewContainer, { elRef: this.scrollElRef, elClasses: rootClassNames, viewSpec: context.viewSpec }, monthDateProfiles.map((monthDateProfile, i) => {
        ...
        return (preact.createElement(SingleMonth, Object.assign({}, props, { key: monthStr, isoDateStr: monthStr, elRef: i === 0 ? this.firstMonthElRef : undefined, titleFormat: monthTitleFormat, dateProfile: monthDateProfile, width: monthWidthPct, tableWidth: monthTableWidth, clientWidth, clientHeight })))
      })))
    }
