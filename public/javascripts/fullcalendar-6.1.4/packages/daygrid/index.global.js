...
FullCalendar.DayGrid = (function (exports, core, internal$1, preact) {
  ...
  class TableView extends internal$1.DateComponent {
    ...
    renderSimpleLayout (headerRowContent, bodyContent) {
      ...
      return (preact.createElement(internal$1.ViewContainer, { elClasses: ['fc-daygrid'], viewSpec: context.viewSpec },
        preact.createElement(internal$1.SimpleScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, cols: [] /* TODO: make optional? */, sections })))
    }
    ...
    renderHScrollLayout (headerRowContent, bodyContent, colCnt, dayMinWidth) {
      ...
      return (preact.createElement(internal$1.ViewContainer, { elClasses: ['fc-daygrid'], viewSpec: context.viewSpec },
        preact.createElement(ScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, colGroups: [{ cols: [{ span: colCnt, minWidth: dayMinWidth }] }], sections })))
    }
  }
  ...
  class TableListItemEvent extends internal$1.BaseComponent {
    render () {
      ...
      const timeText = internal$1.buildSegTimeText(seg, timeFormat, context, true, props.defaultDisplayEventEnd)
      return (preact.createElement(internal$1.EventContainer, Object.assign({}, props, { elTag: 'a', elClasses: ['fc-daygrid-event', 'fc-daygrid-dot-event'], elAttrs: internal$1.getSegAnchorAttrs(props.seg, context), defaultGenerator: renderInnerContent, timeText, isResizing: false, isDateSelecting: false })))
    }
  }
      ...
      return (preact.createElement(internal$1.MoreLinkContainer, {
        ...
        popoverContent: () => {
          ...
          return (preact.createElement(preact.Fragment, null, allSegs.map((seg) => {
            ...
            }, hasListItemDisplay(seg) ? (preact.createElement(TableListItemEvent, Object.assign({ seg, isDragging: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false }, internal$1.getSegMeta(seg, props.todayRange)))) : (preact.createElement(TableBlockEvent, Object.assign({ seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false }, internal$1.getSegMeta(seg, props.todayRange))))))
          })))
        }
      }))
    }
  ...
  class TableCell extends internal$1.DateComponent {
    ...
    render () {
      ...
      return (preact.createElement(internal$1.DayCellContainer, {
        ...
        props.showWeekNumber && (preact.createElement(internal$1.WeekNumberContainer, { elTag: 'a', elClasses: ['fc-daygrid-week-number'], elAttrs: internal$1.buildNavLinkAttrs(context, date, 'week'), date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT })),
  ...
  function resliceSeg (seg, spanStart, spanEnd, cells) {
    ...
    const slicedRange = internal$1.intersectRanges(origRange, {
  ...
  class TableRow extends internal$1.DateComponent {
    ...
    render () {
      ...
      const { singleColPlacements, multiColPlacements, moreCnts, moreMarginTops } = computeFgSegPlacement(internal$1.sortEventSegs(props.fgEventSegs, options.eventOrder), props.dayMaxEvents, props.dayMaxEventRows, options.eventOrderStrict, state.eventInstanceHeights, state.maxContentHeight, props.cells)
    ...
    renderFgSegs (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
      ...
      if (framePositions) {
        for (const placement of segPlacements) {
          ...
          }, hasListItemDisplay(seg) ? (preact.createElement(TableListItemEvent, Object.assign({ seg, isDragging, isSelected: instanceId === eventSelection, defaultDisplayEventEnd }, internal$1.getSegMeta(seg, todayRange)))) : (preact.createElement(TableBlockEvent, Object.assign({ seg, isDragging, isResizing, isDateSelecting, isSelected: instanceId === eventSelection, defaultDisplayEventEnd }, internal$1.getSegMeta(seg, todayRange))))))
        }
      }
      return nodes
    }
      ...
      if (framePositions) {
        for (const seg of segs) {
          ...
          nodes.push(preact.createElement('div', { key: internal$1.buildEventRangeKey(seg.eventRange), className: 'fc-daygrid-bg-harness', style: leftRightCss }, fillType === 'bg-event'
            ? preact.createElement(internal$1.BgEvent, Object.assign({ seg }, internal$1.getSegMeta(seg, todayRange)))
      ...
      if (!props.forPrint &&
        ...
        if (isExternalSizingChange) {
          ...
          if (frameEls.length) {
            ...
            const newPositionCache = new internal$1.PositionCache(originEl, frameEls, true, // isHorizontal
              false)
  ...
  class TableRows extends internal$1.DateComponent {
    ...
    getCellRange (row, col) {
      ...
      const end = internal$1.addDays(start, 1)
      return { start, end }
    }
  }
  ...
  class DayTableView extends TableView {
    ...
    render () {
      ...
      const headerContent = options.dayHeaders && (preact.createElement(internal$1.DayHeader, { ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepDistinctDays: dayTableModel.rowCnt === 1 }))
      const bodyContent = (contentArg) => (preact.createElement(DayTable, { ref: this.tableRef, dateProfile: props.dateProfile, dayTableModel, businessHours: props.businessHours, dateSelection: props.dateSelection, eventStore: props.eventStore, eventUiBases: props.eventUiBases, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, nextDayThreshold: options.nextDayThreshold, colGroupNode: contentArg.tableColGroupNode, tableMinWidth: contentArg.tableMinWidth, dayMaxEvents: options.dayMaxEvents, dayMaxEventRows: options.dayMaxEventRows, showWeekNumbers: options.weekNumbers, expandRows: !props.isHeightAuto, headerAlignElRef: this.headerElRef, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, forPrint: props.forPrint }))
  ...
  function buildDayTableRenderRange (props) {
    ...
    if (props.fixedWeekCount) {
      ...
      const lastMonthRenderStart = dateEnv.startOfWeek(dateEnv.startOfMonth(internal$1.addDays(currentRange.end, -1)))
