...
FullCalendar.List = (function (exports, core, internal$1, preact) {
  ...
  class ListViewHeaderRow extends internal$1.BaseComponent {
    ...
    render () {
      ...
      const dayMeta = internal$1.getDateMeta(dayDate, todayRange)
      // will ever be falsy?
  ...
  function renderEventInnerContent (seg, context) {
    const interactiveAttrs = internal$1.getSegAnchorAttrs(seg, context)
      ...
      return (preact.createElement(internal$1.NowTimer, { unit: 'day' }, (nowDate, todayRange) => {
        ...
        for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
          ...
          if (daySegs) { // sparse array, so might be undefined
            const dayStr = internal$1.formatDayString(dayDates[dayIndex])
            const dateHeaderId = dateHeaderIdRoot + '-' + dayStr
            // append a day header
            innerNodes.push(preact.createElement(ListViewHeaderRow, { key: dayStr, cellId: dateHeaderId, dayDate: dayDates[dayIndex], todayRange }))
            daySegs = internal$1.sortEventSegs(daySegs, options.eventOrder)
            for (const seg of daySegs) {
              innerNodes.push(preact.createElement(ListViewEventRow, Object.assign({ key: dayStr + ':' + seg.eventRange.instance.instanceId /* are multiple segs for an instanceId */, seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, timeHeaderId, eventHeaderId, dateHeaderId }, internal$1.getSegMeta(seg, todayRange, nowDate))))
            }
          }
        }
